...
```{r, echo=FALSE}
vembedr::embed_youtube("U8J24T-eY0U", width = 770, height = 433)
```
...
```{r, echo=FALSE}
vembedr::embed_youtube("KMAONv3BPhs", width = 770, height = 433)
```
...
```{r, echo=FALSE}
vembedr::embed_youtube("FtesVo3U4v0", width = 770, height = 433)
```

- Intervention de Sébastien Bette.

```{r, echo=FALSE}
vembedr::embed_youtube("CAXfg7PbRdY", width = 770, height = 433)
```

Questions croisées aux deux intervenants.

```{r, echo=FALSE}
vembedr::embed_youtube("DIhp6P4HuB8", width = 770, height = 433)
```
...
```{r, echo=FALSE}
vembedr::embed_youtube("Ckp4AvvhZ_A", width = 770, height = 433)
```
...
```{r, echo=FALSE}
vembedr::embed_youtube("Iwpi1Lm6dFo", width = 770, height = 433)
```

Quelques conseils pour améliorer sa présentation PowerPoint ici\ :

```{r, echo=FALSE}
vembedr::embed_youtube("U_HN7H8n8E", width = 770, height = 433)
```

Don McMillan est un humoriste qui réussit à faire passer le message d'une manière hilarante ici\ :

```{r, echo=FALSE}
vembedr::embed_youtube("KbSPPFYxx3o", width = 770, height = 433)
```
...
```{r, echo=FALSE}
vembedr::embed_youtube("Hz1fyhVOjr4", width = 770, height = 433)
```
