...
## Intégration Wordpress - bookdown

Tel que réalisé jusqu'ici, l'intégration Wordpress - bookdown est déjà pas trop mal, en particulier pour les widgets h5p. Ce qui serait bien d'implémenter en plus\ :

- Pouvoir transmettre l'identité du visiteur Wordpress aux learnrs et applis Shiny, ce qui nous dispenserait de l'identification manuelle actuelle bancale,

- Pouvoir afficher le bandeau Wordpress de l'utilisateur en haut des pages bookdown afin de pouvoir déterminer d'un coup d'œil si on est connecté ou pas au site, quelque soit la page actuellement affichée et avoir à tout instant accès à nos paramètres Wordpress et au tableau de bord. 
