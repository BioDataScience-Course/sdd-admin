...
Nous avons installé les extensions suivantes (les versions correspondent à la configuration de Wordpress au 06/01/2021)\ :
...
- Quelques autres plugins aident à gérer le site Wordpress\ : **[Broken Link Checker](https://fr.wordpress.org/plugins/broken-link-checker/) 1.11.15**, **[Health Check & Troubleshooting](https://fr.wordpress.org/plugins/health-check/) 1.4.5** & **[WP-Optimize](https://fr.wordpress.org/plugins/wp-optimize/) 3.1.6**.
